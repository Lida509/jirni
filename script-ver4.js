...
function showFinalMessage() {
  ...
  text.innerText = "Congratulations, now you are true fat man.";
...
function checkWin() {
  if (playerPos === targetPos) {
    ...
    updateLevelButtons();
    if (currentLevel < 3) setLevel(currentLevel + 1);
    else { 
      setMessage("🎉 Вітаю! Ти пройшов усі рівні!", true); 
      showFinalMessage();
    }
  } else {
...
// Нова версія setLevel з 10-секундним затемненням
function setLevel(level) {
  ...
  overlayEl.innerText = "Переходимо на наступний рівень...";
